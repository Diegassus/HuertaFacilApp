...
public class ContrariasViewModel extends AndroidViewModel {
  private Context context;
  private ArrayList<PlantaListado> plantas;
  private MutableLiveData<ArrayList<PlantaListado>> listaPlantas;

  public ContrariasViewModel(@NonNull Application application) {
    super(application);
  ...
  public void buscarPlantas(Bundle bundle){
    ...
    Call<List<PlantaListado>> call = endpoint.listadoContrarias(token,bundle.getInt("PlantaId"));
