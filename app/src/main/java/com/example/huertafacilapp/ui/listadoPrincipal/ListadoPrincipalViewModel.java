...
public class ListadoPrincipalViewModel extends AndroidViewModel {
    private Context context;
    private ArrayList<PlantaListado> plantas;
    private MutableLiveData<ArrayList<PlantaListado>> listaPlantas;

    public ListadoPrincipalViewModel(@NonNull Application application) {
        super(application);
    ...
    private void buscarPlantas(){
        ...
        Call<List<PlantaListado>> call = endpoint.listadoPrincipal(token);
            ...
            public void onResponse(Call<List<PlantaListado>> call, Response<List<PlantaListado>> response) {
                if(response.isSuccessful()){
                    if(response.body()!=null){
                        ...
                        Log.d("Mensaje","Funciono la request");
                    }
                }
            }
